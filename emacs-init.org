...
In case this configuration is run on a clean Emacs installation, it will ask if
you want to install external dependencies. Since there's quite a few of those,
you can press =!= to install all of them.
