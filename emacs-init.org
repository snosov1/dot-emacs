...
And it turned out to be so convenient, that now I can't imagine myself giving it
up.
...
You can do the same thing with the help of =align-regexp= function, but if you
already created the cursors anyway, then M-' is a handy tool.
