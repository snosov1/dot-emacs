...
programs. Like, it doesn't fiddle around with git blobs, but provides a nice
interface via =magit=.

TODO
And, as you can see, this way
- has a lot of pros
- doesn't look conventional (or common)
- a possible rule of thumb - if you can't do this easily in Emacs, probably,
