...
* Contents                                                   :noexport:TOC_1:
 ...
 - [[#smarter-alternatives-to-built-in-functions]["Smarter" alternatives to built-in functions]]
...
* "Smarter" alternatives to built-in functions

The following functions tries to be smarter about what they do, while closely
...
** Subword
** Nifty tricks
*** show-file-name, replace-path-with-truename
*** double-quote-word?
** Text manipulations
*** Move text
*** Fill/unfill
