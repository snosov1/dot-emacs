...
- after I press =(=, =[=, ="= and ={= it should behave, like I pressed the key
...
Before I did this, my last try was =smartparens=. It seemed like a nice idea,
when I was reading the description. But the thing actually puts an overlay on
braces, has some notion of state and prints messages to the echo area - all of
this for a pair of braces.
...
- When you press an open pair key it issues the exact same command as if the
