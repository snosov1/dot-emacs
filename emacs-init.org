...
All I really need for programming is =C-c C-c= to issue the =compile= command. I
don't even need a shell, really. But if I'm to pick one for Python, it will,
obviously, be =ipython=.
