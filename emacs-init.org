...
else must have already build a perfect environment. I should simply find it and
use it".
    ...
    '(progn
       (when (require 'expand-region nil t)
         (add-hook 'text-mode-hook
                   '(lambda ()
                      (setq-local er/try-expand-list (remove 'er/mark-method-call er/try-expand-list))
